 ...
 */
template <class T>
const T& ValueArg<T>::getValue() const {
    return _value;
}
 ...
 */
template <class T>
std::string ValueArg<T>::shortID(const std::string& /*unused*/) const {
 ...
 */
template <class T>
std::string ValueArg<T>::longID(const std::string& /*unused*/) const {
