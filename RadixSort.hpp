...
template <typename T> class LSDRadixSort {
...
template <typename T> class MSDRadixSort {
  static_assert(std::is_integral<T>::value,
                "Radix sort cannot be applied to non integral number");
  static_assert(
      std::is_unsigned<T>::value,
...
template <typename T> class CountingLSDRadixSort {
  static_assert(std::is_integral<T>::value,
                "Radix sort cannot be applied to non integral number");
  static_assert(
      std::is_unsigned<T>::value,
...
template <typename T> class CountingMSDRadixSort {
  static_assert(std::is_integral<T>::value,
                "Radix sort cannot be applied to non integral number");
  static_assert(
      std::is_unsigned<T>::value,
